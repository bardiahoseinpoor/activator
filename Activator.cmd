...
::   managed by:nullgang12(mohamad)
::
::   Homepage: nullgang12.gt.tc
::      Email: bardiahoseinpoor3@gmail.com
::
::============================================================================
...
cls
color 07
title  windows activator(created by bardia hoseinpoor)
...
if %_lock%==0 ((err_invalid version(report to bardia hoseinpoor comunity to fix))) else ((err_invalid version(report to bardia hoseinpoor comunity to fix)) [Lockbox Method])
...
(err_invalid version(report to bardia hoseinpoor comunity to fix))
...
cls
set _gui=1
title  (err_invalid version(report to bardia hoseinpoor comunity to fix))
...
echo:
echo done.
echo presented by bardia hoseinpoor
